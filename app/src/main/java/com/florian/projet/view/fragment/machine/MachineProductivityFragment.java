...
public class MachineProductivityFragment extends Fragment {
    ArticleViewModel articleViewModel;

    public MachineProductivityFragment() {

    }

    public static MachineProductivityFragment newInstance() {
        MachineProductivityFragment fragment = new MachineProductivityFragment();
