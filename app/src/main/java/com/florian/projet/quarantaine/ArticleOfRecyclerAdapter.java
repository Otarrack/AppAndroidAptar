...
public class ArticleOfRecyclerAdapter extends RecyclerView.Adapter<ArticleOfRecyclerAdapter.MyHolder> {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        MyHolder(View itemView) {
            super(itemView);
            itemLayout = itemView.findViewById(R.id.recycler_machine_layout);
            numOFTextView = itemView.findViewById(R.id.recycler_machine_num);
            startDateTextView = itemView.findViewById(R.id.recycler_machine_1_res);
            endDateTextView = itemView.findViewById(R.id.rrecycler_machine_2_res);
            askedQtTextView = itemView.findViewById(R.id.recycler_machine_3_res);
        }
    }
}
